...
-----------------------
--DIZZY_MONEYLAUNDRING
-----------------------
Config.Location = vector3(1122.316528, -3194.479, -40.411)--Where is the laundry located?
...
Config.WashingTime = 8 -- in seconds, how long should the washing process take??
Config.Collectingtime = 10 --in seconds, how long in seconds should it take to collect cash once they have been washed??
Config.Notifications = "okok"
-- Options here: "okok" for okokNotifications, "mythic" for mythicNotifications
...
Config.NoValueError = "You need to put in a value in order to wash.."
------------------------------------------------------------------------------
------------------------------------------------------------------------------
